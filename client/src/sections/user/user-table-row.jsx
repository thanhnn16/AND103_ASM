  ...
  return (
    <>
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          onSubmit: async (event) => {
            ...
            await instance.post(`/user/delete/${_id}`)
              .then((res) => {
                console.log(res);
                if ('data' in res) {
                  const { data } = res;
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Xác nhận xoá khách hàng này? Vui nhập nhập chữ &quot;Xoá&quot; để tiếp tục.
          </DialogContentText>
          <TextField
            autoFocus
            required
        ...
        <DialogActions>
          ...
          <Button type="submit" disabled={cfm !== 'Xoá'} color="error">Xoá</Button>
        </DialogActions>
      </Dialog>
    </>
  );
